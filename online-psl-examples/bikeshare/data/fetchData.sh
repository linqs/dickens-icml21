...
readonly DATA_URL='https://linqs-data.soe.ucsc.edu/public/dickens-icml21/bikeshare/bikeshare.zip'
readonly DATA_FILE='bikeshare.zip'
readonly DATA_DIR='bikeshare'
