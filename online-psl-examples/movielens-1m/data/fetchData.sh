...
readonly DATA_URL='https://linqs-data.soe.ucsc.edu/public/dickens-icml21/movielens-1m/movielens-1m.zip'
readonly DATA_FILE='movielens-1m.zip'
readonly DATA_DIR='movielens-1m'
